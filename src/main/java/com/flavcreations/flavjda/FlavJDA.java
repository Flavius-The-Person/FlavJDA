...
import com.flavcreations.flavjda.settings.SETTINGS;
...
public class FlavJDA extends ListenerAdapter
{
	/**
	...
	public static void main(String[] args)
	{
		...
		try
		{
			JDA jda = JDABuilder.createDefault(SETTINGS.token) // The token of the account that is logging in.
					.addEventListeners(new FlavJDA())   // An instance of a class that will handle events.
					.build();
	...
	public void onMessageReceived(MessageReceivedEvent event)
	{
		...
		if (msg.equals("!ping"))
		{
			...
			if(channel.getId().equals("743196192686735370"))
			{
				channel.sendMessage("pong!").queue();
			}
		}
